...
const fs = require('fs')
let client = Eris('ODU1NTQ2ODgyOTkzNjg0NDgw.YM0EIA.M3DlMtaHVg4nRIWkHPZK-eRT9Do', {restMode: true, defaultImageSize: 2048})
...
var allusers = []
client.on('ready', () =>{
  client.editStatus("online", { name: "$help", type: 0}) 
if(add === true){
setInterval(async () => {
