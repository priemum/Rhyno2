...
mention = true
    ...
    if(user.bot) return client.createMessage(msg.channel.id,
     {embed:{
      ...
      fetch(('https://123123h.glitch.me/api/v1/profile/' + user.id + "/" + msg.channel.guild.id) , {method: 'GET', headers: { 'Content-Type': 'application/json' }, referrerPolicy: "no-referrer"}).then(async ress =>{
