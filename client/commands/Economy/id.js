...
fetch(('https://123123h.glitch.me/api/v1/rank/' + user.id + "/" + msg.channel.guild.id) , {method: 'GET', headers: { 'Content-Type': 'application/json' }, referrerPolicy: "no-referrer"}).then(async ress =>{
