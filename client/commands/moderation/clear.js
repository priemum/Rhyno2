...
if(!msg.member.permission.has('manageMessages')) return client.createMessage(msg.channel.id, :lang_messages[0].managemessages[lang])
...
console.log(number)
  ...
  client.createMessage(msg.channel.id, lang_messages[0].done_delete[lang] + num + lang_messages[0].messages[lang]).then(async m =>{
